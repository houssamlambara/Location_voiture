<?php
include_once './signupController.php'; // Inclusion de la classe User
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Appel de la méthode pour traiter l'inscription
    $user->register();
}
?>
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="#" class="flex-shrink-0">
                        <img class="h-10 w-auto" src="https://via.placeholder.com/150x50?text=RoadRover" alt="RoadRover Logo">
                    </a>
                </div>
                <!-- Navigation Links -->
                ...
                <div class="flex items-baseline space-x-4">
                        ...
                        <a href="../front_end/categorie.php" class="text-white hover:bg-gray-200 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Nos Véhicules</a>
                        <a href="../front_end/reservation.php" class="text-white hover:bg-gray-200 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Réservation</a>
                        <a href="../front_end/about.php" class="text-white hover:bg-gray-200 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">À Propos</a>
                        <a href="../front_end/contact.php" class="text-white hover:bg-gray-200 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Contact</a>
                    </div>
                </div>
                <!-- Sign In Button -->
                <div>
                    <a href="../login/signin.php" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 text-sm font-medium">Sign In</a>
                </div>
            </div>
        </div>
    </nav>
